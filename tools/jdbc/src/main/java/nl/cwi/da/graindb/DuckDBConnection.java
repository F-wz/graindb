...
public class GrainDBConnection implements java.sql.Connection {
	protected ByteBuffer conn_ref = null;
	protected GrainDBDatabase db;

	public GrainDBConnection(GrainDBDatabase db) {
		conn_ref = GrainDBNative.graindb_jdbc_connect(db.db_ref);
		GrainDBNative.graindb_jdbc_set_auto_commit(conn_ref, true);
		this.db = db;
	}
	...
	public Statement createStatement() throws SQLException {
		...
		return new GrainDBPreparedStatement(this);
	}
	...
	public synchronized void close() throws SQLException {
		if (conn_ref != null) {
			GrainDBNative.graindb_jdbc_disconnect(conn_ref);
			conn_ref = null;
		}
		db = null;
	}
	...
	public void setAutoCommit(boolean autoCommit) throws SQLException {
		...
		GrainDBNative.graindb_jdbc_set_auto_commit(conn_ref, autoCommit);
	}
	...
	public boolean getAutoCommit() throws SQLException {
		...
		return GrainDBNative.graindb_jdbc_get_auto_commit(conn_ref);
	}
	...
	public PreparedStatement prepareStatement(String sql) throws SQLException {
		...
		return new GrainDBPreparedStatement(this, sql);
	}

	public DatabaseMetaData getMetaData() throws SQLException {
		return new GrainDBDatabaseMetaData(this);
	}
