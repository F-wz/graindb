...
public class GrainDBResultSetMetaData implements ResultSetMetaData {

	public GrainDBResultSetMetaData(int param_count, int column_count, String[] column_names, String[] column_types) {
