...
public class GrainDBPreparedStatement implements PreparedStatement {
	private GrainDBConnection conn;

	private ByteBuffer stmt_ref = null;
	private GrainDBResultSet select_result = null;
	private int update_result = 0;
	private boolean is_update = false;
	private Object[] params = new Object[0];
	private GrainDBResultSetMetaData meta = null;

	public GrainDBPreparedStatement(GrainDBConnection conn) throws SQLException {
		if (conn == null) {
	...
	public GrainDBPreparedStatement(GrainDBConnection conn, String sql) throws SQLException {
		if (conn == null) {
			throw new SQLException("connection parameter cannot be null");
		}
		if (sql == null) {
	...
	private void prepare(String sql) throws SQLException {
		...
		stmt_ref = GrainDBNative.graindb_jdbc_prepare(conn.conn_ref, sql.getBytes(StandardCharsets.UTF_8));
		meta = GrainDBNative.graindb_jdbc_meta(stmt_ref);
		params = new Object[0];
		// TODO add query type to meta
		String query_type = GrainDBNative.graindb_jdbc_prepare_type(stmt_ref);
	...
	public boolean execute() throws SQLException {
		...
		ByteBuffer result_ref = GrainDBNative.graindb_jdbc_execute(stmt_ref, params);
		select_result = new GrainDBResultSet(this, meta, result_ref);
	...
	public ParameterMetaData getParameterMetaData() throws SQLException {
		...
		return new GrainDBParameterMetaData(meta);
	}
	...
	public void close() throws SQLException {
		if (stmt_ref != null) {
			GrainDBNative.graindb_jdbc_release(stmt_ref);
			stmt_ref = null;
		}
	...
	public int getFetchSize() throws SQLException {
		return GrainDBNative.graindb_jdbc_fetch_size();
	}
